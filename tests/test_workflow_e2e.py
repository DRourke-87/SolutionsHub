...
def _form(db, **overrides):
    ...
    data = {
        ...
        "key_differentiators": "- Deploy in hours\n- Realistic\n- Cost effective",
        ...
        "relevant_partnerships": "Range Partner Inc",
        "partnership_url": "https://example.internal/partner",
        "sensitive_data_ack": "1",
        "contact_name": ["Olivia Owner", "Chris Colead"],
        "contact_email": ["olivia.owner@amentum.com", "chris.colead@amentum.com"],
        "contact_role": ["owner_technical", "owner_operations"],
        "contact_phone": ["", ""],
